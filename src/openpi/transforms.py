...
class TokenizeFASTInputs(DataTransformFn):
    ...
    def __call__(self, data: DataDict) -> DataDict:
        ...
        print(f"Tokenized prompt(task + state + actions): {tokens}, token mask: {token_mask}, ar mask: {ar_mask}")
        return {
            **data,
...
class TokenizeDFMLangState(DataTransformFn):
    ...
    """Tokenizes the language and state for the DFM model."""
    ...
    def __call__(self, data: DataDict) -> DataDict:
        ...
        return {**data, "prefix_token": prefix_tokens, "prefix_mask": prefix_mask}
